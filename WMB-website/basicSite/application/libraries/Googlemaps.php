...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDBAXq9xOI_ynPffhkPhM1Z-8qFY1fUjVE'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $map_div_id					= "map";				// The ID of the <div></div> that is output which contains the map
	...
	var $placesRadius				= 500;						// The radius (in meters) if search is based around a central position
